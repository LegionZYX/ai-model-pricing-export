...
- `output/78code_group_models.csv`: group membership plus effective price after multiplier
- `output/78code_group_price_items.csv`: itemized effective prices after multiplier
